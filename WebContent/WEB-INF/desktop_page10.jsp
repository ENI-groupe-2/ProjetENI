...
<head>
    ...
    <link rel="stylesheet" href="CSS/feuille_de_style_p10.css">
...
<body>
    ...
    <form>
        ...
        <div id="infos"> <!-- Informations de l'article -->
            ...
            <input id="prixOrig" name="prixOrig" type="number" min="5" step="5" placeholder="5"> 
        ...
        <div id="bouton"> <!-- Boutons : ENREGISTRER, ANNULER et ANNULER LA VENTE-->
            ...
            <input type="reset" name="annulerLaVente" value="Annuler la vente" class="boutonForm" title="Annuler la vente"/>
        </div>
